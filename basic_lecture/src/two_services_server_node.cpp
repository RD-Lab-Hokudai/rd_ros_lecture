/**
 * @file two_services_server_node.cpp
 * @brief std_srvs/Emptyとstd_srvs/SetBoolのそれぞれの型による２つのserviceを持つnode(server側のnode)
 */
...
{
  ros::init(argc, argv, "two_services_server_node");
  ros::NodeHandle n;
